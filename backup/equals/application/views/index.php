  ...
  <section class="">
    <div id="owl-example" class="banner owl-carousel">
      <div class="main-banner">
        <div class="item">
          <div class="banner-1"> <img src="../assets/images/banner1.jpg" alt="Stylexpo">
        ...
        <div class="item">
          <div class="banner-2"> <img src="../assets/images/banner2.jpg" alt="Stylexpo">
            <div class="banner-detail">
              <div class="container">
                <div class="row">
                  <div class="col-8">
        ...
        <div class="item">
          <div class="banner-3"> <img src="../assets/images/banner3.jpg" alt="Stylexpo">
            <div class="banner-detail">
              <div class="container">
                <div class="row">
          ...
          <div class="row m-0">
            <div class="col-md-4 mt-xs-30 p-0">
              <div class="sub-banner sub-banner1" >
                <img alt="Stylexpo" src="../assets/images/sub-banner1.jpg">
            ...
            <div class="col-md-4 mt-xs-30 p-0">
              <div class="">
                <div class="sub-banner sub-banner2">
                  <img alt="Stylexpo" src="../assets/images/sub-banner2.jpg">
                  <div class="sub-banner-detail">
            ...
            <div class="col-md-4 mt-xs-30 p-0">
              <div class="sub-banner sub-banner3" >
                <img alt="Stylexpo" src="../assets/images/sub-banner3.jpg">
                <div class="sub-banner-detail">
              ...
              <div class="owl-carousel pro-cat-slider ">
                ...
                <div class="item">
                  <div class="product-item sold-out mb-30">
                    <div class="main-label sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/2.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                  ...
                  <div class="product-item">
                    <div class="main-label new-label"><span>New</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/9.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  <div class="product-item mb-30">
                    <div class="main-label new-label"><span>New</span></div>
                    <div class="main-label sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/3.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                  ...
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/10.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  <div class="product-item mb-30">
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/4.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                  ...
                  <div class="product-item sold-out">
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/7.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  <div class="product-item mb-30">
                    <div class="main-label sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/8.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  <div class="product-item mb-30">
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/6.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                  ...
                  <div class="product-item">
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/11.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  <div class="product-item mb-30">
                    <div class="main-label new-label"><span>New</span></div>
                    <div class="main-label sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/13.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  ...
                  <div class="product-item">
                    <div class="main-label sale-label"><span>Sale</span></div>
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/15.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
                ...
                <div class="item">
                  <div class="product-item mb-30">
                    <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/16.jpg" alt="Stylexpo"> </a>
                      <div class="product-detail-inner">
                        <div class="detail-inner-left align-center">
                          <ul>
                            <li class="pro-cart-icon">
            ...
            <div class="row">
              <div id="top-cat-pro" class="owl-carousel sell-pro align-center">
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_1.jpg" alt="Stylexpo">
                ...
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_2.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                ...
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_3.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <span>watches</span>
                      </div>
                    </div>
                ...
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_4.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                        <span>shoes</span>
                      </div>
                    </div>
                ...
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_5.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                ...
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_6.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                ...
                <div class="item ">
                  <a href="shop.html">
                    <div class="item-inner">
                        <img src="../assets/images/cate_7.jpg" alt="Stylexpo">
                      <div class="cate-detail">
                  ...
                  <div class="product-item">
                    <div class="row ">
                      <div class="col-md-6 col-12 deals-img ">
                        <div class="product-image">
                          <a href="product-page.html">
                            <img src="../assets/images/12.jpg" alt="Stylexpo">
                          </a>
                        </div>
                      </div>
                      <div class="col-md-6 col-12 mt-xs-30">
                  ...
                  <div class="product-item">
                    <div class="row ">
                      <div class="col-md-6 col-12 deals-img ">
                        <div class="product-image">
                          <a href="product-page.html">
                            <img src="../assets/images/1.jpg" alt="Stylexpo">
                          </a>
                        </div>
                      </div>
                      <div class="col-md-6 col-12 mt-xs-30">
                  ...
                  <div class="product-item">
                    <div class="row ">
                      <div class="col-md-6 col-12 deals-img ">
                        <div class="product-image">
                          <a href="product-page.html">
                            <img src="../assets/images/3.jpg" alt="Stylexpo">
                          </a>
                        </div>
                      </div>
                      <div class="col-md-6 col-12 mt-xs-30">
                  ...
                  <div class="product-item">
                    <div class="row ">
                      <div class="col-md-6 col-12 deals-img ">
                        <div class="product-image">
                          <a href="product-page.html">
                            <img src="../assets/images/4.jpg" alt="Stylexpo">
                          </a>
                        </div>
                      </div>
                      <div class="col-md-6 col-12 mt-xs-30">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="sub-banner small-banner small-banner1">
              <a href="#">
                <img src="../assets/images/small-banner1.jpg" alt="Stylexpo">
              </a>
            </div>
          </div>
          <div class="col-lg-6 mt-sm-30">
            <div class="sub-banner small-banner small-banner2">
              <a href="#">
                <img src="../assets/images/small-banner2.jpg" alt="Stylexpo">
              </a>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="owl-carousel best-seller-pro">
                    ...
                    <div class="item">
                      <div class="product-item">
                        <div class="main-label sale-label"><span>Sale</span></div>
                        <div class="product-image"> <a href="product-page.html"> <img src="../assets/images/5.jpg" alt="Stylexpo"> </a>
                          <div class="product-detail-inner">
                            <div class="detail-inner-left align-center">
                              <ul>
                                <li class="pro-cart-icon">
        ...
        <div class="row">
          <div id="blog" class="owl-carousel">
            <div class="item mb-md-30">
              <div class="blog-item">
                ...
                <div class="blog-media">
                  <img src="../assets/images/blog_img1.jpg" alt="Stylexpo">
            ...
            <div class="item mb-md-30">
              <div class="blog-item">
                <div class="blog-media">
                  <img src="../assets/images/blog_img2.jpg" alt="Stylexpo">
                  <div class="blog-effect"></div>
                  <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                </div>
                <div class="mt-30">
            ...
            <div class="item">
              <div class="blog-item">
                <div class="blog-media">
                  <img src="../assets/images/blog_img3.jpg" alt="Stylexpo">
                  <div class="blog-effect"></div>
                  <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                </div>
                <div class="mt-30">
            ...
            <div class="item">
              <div class="blog-item">
                <div class="blog-media">
                  <img src="../assets/images/blog_img4.jpg" alt="Stylexpo">
                  <div class="blog-effect"></div>
                  <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                </div>
                <div class="mt-30">
            ...
            <div class="item">
              <div class="blog-item">
                <div class="blog-media">
                  <img src="../assets/images/blog_img5.jpg" alt="Stylexpo">
                  <div class="blog-effect"></div>
                  <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                </div>
                <div class="mt-30">
            ...
            <div class="item">
              <div class="blog-item">
                <div class="blog-media">
                  <img src="../assets/images/blog_img6.jpg" alt="Stylexpo">
                  <div class="blog-effect"></div>
                  <a href="single-blog.html" title="Click For Read More" class="read">&nbsp;</a>
                </div>
                <div class="mt-30">
        ...
        <div class="row brand">
          <div class="col-md-12">
            <div id="brand-logo" class="owl-carousel align_center">
              <div class="item"><a href="#"><img src="../assets/images/brand1.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand2.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand3.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand4.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand5.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand6.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand7.png" alt="Stylexpo"></a></div>
              <div class="item"><a href="#"><img src="../assets/images/brand8.png" alt="Stylexpo"></a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="footer-inner">
        ...
        <div class="footer-bottom ">
          <div class="row mtb-30">
            <div class="col-lg-6 ">
              <div class="copy-right ">© 2019 All Rights Reserved. Design By <a href="#">Aaryaweb</a></div>
            </div>
            <div class="col-lg-6 ">
            ...
            <div class="col-12 ">
              <div class="payment">
                <ul class="payment_icon">
                  <li class="visa"><a href="#"><img src="../assets/images/pay1.png" alt="Stylexpo"></a></li>
                  <li class="discover"><a href="#"><img src="../assets/images/pay2.png" alt="Stylexpo"></a></li>
                  <li class="paypal"><a href="#"><img src="../assets/images/pay3.png" alt="Stylexpo"></a></li>
                  <li class="vindicia"><a href="#"><img src="../assets/images/pay4.png" alt="Stylexpo"></a></li>
                  <li class="atos"><a href="#"><img src="../assets/images/pay5.png" alt="Stylexpo"></a></li>
                </ul>
              </div>
            </div>
          </div>
...
<script src="../assets/highlight.html"></script>
